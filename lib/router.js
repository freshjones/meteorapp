...
(
	...
	{
		except: ['login', 'forgotPassword', 'addrequest']
	}
);
...
Router.map(function() { 
	...
	this.route('requests',{
		path: '/requests',
	    waitOn: function() { return [ App.subs.requests ] },
	    data:function(){
	    	
	    	var requestData = {};
	    	requestData.activeRequests = Requests.find({},{status:{"active":1}});
	    	console.log(requestData.activeRequests);
	    	return requestData;
	    },
	    controller: 'AccountController',
	    action: 'show',
